...
See `EVAL_LOG.md` for evaluation (running the generated tests, not
generating them) status and findings -- split out on 2026-09-14, this
file covers inference (generation) only.
